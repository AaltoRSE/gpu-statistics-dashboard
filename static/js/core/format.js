...
// single link (userLink's /user/<name> deep link, issue #2); name and
// state stay plain text, and every field falls back to the same "?"
// placeholder the pre-link textContent title used, so metadata that never
// resolves reads "(?)" exactly as it did before this builder existed.
