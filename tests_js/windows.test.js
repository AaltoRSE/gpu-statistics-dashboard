...
// Partitions, Users, and Groups tabs must each expose the same five
// windows — 24 h, 3 d, 7 d, 14 d, 30 d — in the same order, with 24 h
// selected by default. One shared contract covers all four selectors
// and fails if a single tab diverges. Node's own test runner + jsdom
// against the app's real index.html.
...
test("every tab's window selector offers the same five ordered windows", () => {
  ...
  for (const id of ["jWindow", "pWindow", "uWindow", "gWindow"]) {
